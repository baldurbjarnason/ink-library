...
<style>
  ...
  ul.tabs li:hover a:not(.selected):before {
    ...
    box-shadow: 3px 3px 7px rgba(147, 99, 210, 0.2);
  }
  .tabs .borders {
    display: none;
  }
  ...
  .public-tab:before {
    ...
    box-shadow: 1.5px 1.5px 4px rgba(111, 176, 201, 0.5);
  }
  ...
  .personal-tab:before {
    ...
    box-shadow: 1.5px 1.5px 4px rgba(134, 209, 209, 0.5);
  }
  .workspaces {
    position: sticky;
    top: 0;
    ...
    <ul class="tabs">
      <li>
        <a
          ...
          {#if workspace === 'all'}
            <div
              class="borders"
              out:send|local|local={{ key: 'tabs-marker' }}
              in:receive|local={{ key: 'tabs-marker' }}>
              <div />
            </div>
          {/if}
      ...
      <li>
        <a
          ...
          class="research-tab"
          class:selected={workspace === 'Research'}>
          {#if workspace === 'Research'}
            <div
              class="borders"
              out:send|local={{ key: 'tabs-marker' }}
              in:receive|local={{ key: 'tabs-marker' }}>
              <div />
            </div>
          {/if}
      ...
      <li>
        <a
          ...
          class="teaching-tab"
          class:selected={workspace === 'Teaching'}>
      ...
      <li>
        <a
          href="/library/Public_Scholarships/all"
          class="public-tab"
          class:selected={workspace === 'Public_Scholarships'}>
      ...
      <li>
        <a
          ...
          class="personal-tab"
          class:selected={workspace === 'Personal'}>
    ...
    <div class="Sidebar {workspace.split('_')[0].toLowerCase()}">
      <h2>
        ...
        {:else if workspace === 'Teaching'}
          Teaching
        {:else if workspace === 'Personal'}Personal{:else}{workspace}{/if}
      </h2>
      <ul>
        <li>
          <a
            href="/library/{workspace}/all"
            class:selected={params.collection === 'all'}>
            <span class="hash all">#</span>
            <span class="linkText">
              {#if workspace === 'all'}
                All items
              {:else}All in {getWorkspaceAsLabel(workspace)}{/if}
            </span>
          </a>
        </li>
        {#each tags as tag}
          <li>
            <a
              ...
              class:selected={params.collection === tag.name}>
              <span class="hash {getWorkspace(tag.name)}">
                <svg
                  ...
                  <path
                    ...
                    31.7012L129.069 64.0553C130.626 64.8781 130.677 67.0892
                    129.16 67.983L67.9625 104.044C67.1793 104.505 66.2074
                    104.505 65.4242 104.044L4.22665 67.983C2.70979 67.0892
                    2.7609 64.8781 4.31744 64.0553L65.5251 31.7012Z"
                    fill="currentColor" />
                  <rect
                    x="8.41211"
                    y="81.5928"
                  ...
                  <rect
                    ...
                    height="11.6562"
                    rx="5.8281"
                    transform="matrix(-0.866025 0.5 0.5 0.866025 124.974
                    81.5928)"
                    fill="currentColor" />
                  <rect
                    x="8.41211"
        ...
        {:else}
          <li>
            <span class="empty">No stacks...</span>
          </li>
        {/each}
      </ul>
    </div>
