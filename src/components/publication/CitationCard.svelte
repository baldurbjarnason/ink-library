...
<style>
  ...
  <Card id="Citation" tab="About" bind:editing={editing} {save}>
    <h2>Citation</h2>
    <div class="Citation">
      {#if editing}
         <textarea name="CitationEdit" id="PublicationCitationEdit" cols="30" rows="2" bind:value={citation} bind:this={textarea}></textarea>
      {:else}
        {citation || ""}
      {/if}
    </div>
