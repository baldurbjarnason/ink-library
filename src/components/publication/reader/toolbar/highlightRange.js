  ...
  for (var i = 0; i < nodes.length; i++) {
    ...
    if (
      ...
      if (node.parentElement instanceof SVGElement) {
        ...
        const width = parent.getSubStringLength(parent.textContent.indexOf(node.textContent), node.textContent.length)
        const x = parent.getStartPositionOfChar(parent.textContent.indexOf(node.textContent)).x
