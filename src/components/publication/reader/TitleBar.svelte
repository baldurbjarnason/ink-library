...
top: 0;
  ...
  .TitleBar ol li a, .TitleBar ol li button {
    color: var(--reader-titlebar-color);
  }
</style>
...
<ol>
  <li><a href="{returnLink}"><svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect x="1.70688" y="5.29285" width="9" height="2" rx="0.999999" transform="rotate(45 1.70688 5.29285)" fill="currentColor" fill-opacity="0.8"/>
<rect x="1.99985" y="5.50012" width="12" height="2" rx="1" fill="currentColor" fill-opacity="0.8"/>
<rect x="7.77817" y="1.41418" width="9" height="2" rx="0.999999" transform="rotate(135 7.77817 1.41418)" fill="currentColor" fill-opacity="0.8"/>
</svg>
</a></li>
...
<circle cx="8" cy="4.5" r="1" fill="currentColor" fill-opacity="0.8"/>
</svg>
</a></li>
</ol>
</nav>