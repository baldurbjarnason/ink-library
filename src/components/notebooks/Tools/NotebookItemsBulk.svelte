<script>
  ...
  import DeletePagesModal from "./DeletePagesModal.svelte";
  import { goto } from "@sapper/app";
  import { getToken } from "../../../getToken";
  import { selectedItems, refreshNotebook, page } from "../../../stores";
...
{:else}
  {#if typeOfItem === 'page'}
    <DeletePagesModal {remove} bind:activeModal items={itemsList} />
  {:else}
